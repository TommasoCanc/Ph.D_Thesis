...
file.number <- which(osf_ls_files(osf_files[2, ], pattern = "01_AUC_>7.csv")[ ,1] == "01_AUC_>7.csv")
osf_download(osf_ls_files(osf_files[2, ], pattern = "01_AUC_>7.csv")[file.number, ], path = main.path)
