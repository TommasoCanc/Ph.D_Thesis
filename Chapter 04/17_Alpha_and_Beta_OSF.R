...
file.number <- which(osf_ls_files(osf_files[2, ], 
          pattern = "tree_treeannotator.nex")[ ,1] == "tree_treeannotator.nex")
osf_download(osf_ls_files(osf_files[2, ],
          pattern = "tree_treeannotator.nex")[file.number, ], path = main.path)
rm(file.number)
...
tree <- read.nexus(paste0(linux, "Odonata_SDM/functional_tree.nex"))
